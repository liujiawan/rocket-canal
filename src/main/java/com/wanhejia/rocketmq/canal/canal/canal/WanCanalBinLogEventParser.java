 ...
 * 解析器
 */
public class WanCanalBinLogEventParser implements CanalBinLogEventParser {
    ...
    private WanCanalBinLogEventParser() {
    }

    public static WanCanalBinLogEventParser of() {
        return new WanCanalBinLogEventParser();
    }
}
